async function buscadorTable(tableId, p_url) {
  let input, busqueda, url;

  console.log("Valor de p_url:", p_url); // Agregar console.log para ver el valor de p_url
  
  if (p_url === 1) {
    url = "/buscando-municipio";
  } 
  
  if (p_url === 2) {
    url = "/buscando-hexagono";
  } 
